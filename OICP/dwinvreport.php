    ...
    <td width="800px" align="left" valign="top" style="padding: 10px 10px 10px 10px; ">
		    <div align="center" style="padding: 10px 10px 10px 10px;">
    	      	<form name="dwsrch" method="post" action="">
        			From Date: <input type="text" name="fromdate" /> To Date: <input type="text" name="todate" /> &nbsp;
                    <input type="submit" name="report" value="Show Report"  /> <br /> Date Format is YYYY-MM-DD
       ...
       <table width="100%" border="1">
             ...
             <?php
				...
				{
					$query=mysql_query("SELECT * FROM inventory where date between '$_REQUEST[fromdate]' and '$_REQUEST[todate]' order by date");
